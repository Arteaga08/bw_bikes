...
/**
 * On-demand cache-buster for the home's CTA tiles (M12, entrega 6) — same
 * shape and same guard as `revalidate/hero-slides/route.ts`, see that file's
