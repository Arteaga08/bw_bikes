...
export const metadata: Metadata = {
  title: "Bicicletas",
  description: "Explora el catálogo completo de bicicletas Black and White Bikes por categoría.",
};

interface BicicletasPageProps {
 ...
 */
export default async function BicicletasPage({ searchParams }: BicicletasPageProps) {
