...
export interface ScrollRailArrowsProps {
 ...
 * on hover of the rail (`group-hover/rail`), and — because
 ...
 * `group-focus-within/rail`, so Tab reveals them exactly like a mouse
 * hover would. Touch never triggers `:hover`, so on a phone these correctly
 * never appear; the gesture there is the swipe itself.
 *
 * The labels are props, not constants: the same arrows drive the category
 * rail and the home's "Novedades" rail, and "Categorías anteriores" would be
 * a lie on the second one.
 */
