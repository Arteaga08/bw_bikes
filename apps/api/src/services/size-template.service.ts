...
import { type ISizeTemplate, MAX_SIZE_TEMPLATES, SizeTemplate } from "../models/index.js";
import { AppError, buildMeta, escapeRegex, parseListQuery } from "../utils/index.js";
import { recordAuditLog } from "./audit-log.service.js";

const MODULE_NAME = "catalog.size-templates";
 ...
 */
export async function learnSizeTemplates(variants: ProductVariant[]): Promise<void> {
  try {
    const sizes = new Set(
...
export const sizeTemplateService = { list, findByIdOrFail, create, update, remove };
